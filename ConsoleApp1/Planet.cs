...
namespace ThePlanets
{
    ...
    // single object for easier management much cleaner organization and better code readability. This also allows us to easily create a collection of Planet objects and
    ...
    public class Planet
    {
        ...
        public double Mass { get; set; }           // Mass in 10^24 kg. Double allows for decimal precision
